...
SWIGEXPORT unsigned long SWIGSTDCALL CSharp_pagmo_problem_get_nobj(void * jarg1) {
  unsigned long jresult ;
  pagmoWrap::problem *arg1 = (pagmoWrap::problem *) 0 ;
  std::vector< double >::size_type result;
  
  arg1 = (pagmoWrap::problem *)jarg1; 
  result = ((pagmoWrap::problem const *)arg1)->get_nobj();
  jresult = (unsigned long)result; 
  return jresult;
}


SWIGEXPORT unsigned long SWIGSTDCALL CSharp_pagmo_problem_get_nec(void * jarg1) {
  unsigned long jresult ;
  pagmoWrap::problem *arg1 = (pagmoWrap::problem *) 0 ;
  std::vector< double >::size_type result;
  
  arg1 = (pagmoWrap::problem *)jarg1; 
  result = ((pagmoWrap::problem const *)arg1)->get_nec();
  jresult = (unsigned long)result; 
  return jresult;
}


SWIGEXPORT unsigned long SWIGSTDCALL CSharp_pagmo_problem_get_nic(void * jarg1) {
  unsigned long jresult ;
  pagmoWrap::problem *arg1 = (pagmoWrap::problem *) 0 ;
  std::vector< double >::size_type result;
  
  arg1 = (pagmoWrap::problem *)jarg1; 
  result = ((pagmoWrap::problem const *)arg1)->get_nic();
  jresult = (unsigned long)result; 
  return jresult;
}


SWIGEXPORT unsigned long SWIGSTDCALL CSharp_pagmo_problem_get_nix(void * jarg1) {
  unsigned long jresult ;
  pagmoWrap::problem *arg1 = (pagmoWrap::problem *) 0 ;
  std::vector< double >::size_type result;
...
SWIGEXPORT char * SWIGSTDCALL CSharp_pagmo_thread_island_get_name(void * jarg1) {
  char * jresult ;
...
SWIGEXPORT char * SWIGSTDCALL CSharp_pagmo_thread_island_get_extra_info(void * jarg1) {
  char * jresult ;
  pagmo::thread_island *arg1 = (pagmo::thread_island *) 0 ;
  std::string result;
...
SWIGEXPORT void SWIGSTDCALL CSharp_pagmo_thread_island_run_evolve(void * jarg1, void * jarg2) {
  ...
  if (!arg2) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "pagmo::island & type is null", 0);
    return ;
  } 
...
SWIGEXPORT char * SWIGSTDCALL CSharp_pagmo_de_get_name(void * jarg1) {
  char * jresult ;
  pagmo::de *arg1 = (pagmo::de *) 0 ;
  std::string result;
...
SWIGEXPORT char * SWIGSTDCALL CSharp_pagmo_de_get_extra_info(void * jarg1) {
  char * jresult ;
  pagmo::de *arg1 = (pagmo::de *) 0 ;
  std::string result;
...
SWIGEXPORT char * SWIGSTDCALL CSharp_pagmo_sade_get_name(void * jarg1) {
  char * jresult ;
  pagmo::sade *arg1 = (pagmo::sade *) 0 ;
  std::string result;
...
SWIGEXPORT char * SWIGSTDCALL CSharp_pagmo_sade_get_extra_info(void * jarg1) {
  char * jresult ;
  pagmo::sade *arg1 = (pagmo::sade *) 0 ;
  std::string result;
