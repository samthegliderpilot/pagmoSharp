...
SWIGEXPORT void * SWIGSTDCALL CSharp_pagmo_fast_non_dominated_sorting_wrapped(void * jarg1) {
  void * jresult ;
  ...
  result = pagmo::fast_non_dominated_sorting_wrapped((std::vector< std::vector< double > > const &)*arg1);
