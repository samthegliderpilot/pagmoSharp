...
C:\Programs\swigwin-4.4.0\swig.exe -c++ -csharp -namespace pagmo -dllimport pagmoWrapper.dll -I..\..\pagmoWrapper -I.\swigInterfaceFileAndPagmoHeaders swigInterfaceFileAndPagmoHeaders\pagmoSharpSwigInterface.i 
