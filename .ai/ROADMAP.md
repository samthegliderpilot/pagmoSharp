...
- Active progress:
  ...
  - [x] Enabled XML documentation file generation in `pagmoSharp.csproj` and stabilized build output (generated-wrapper CS1591 suppressed; handwritten surfaces enforced via dedicated gate script).
...
- [ ] Define and lock v1.0 artifact set:
  - `pagmoSharp` NuGet package (`.nupkg` + `.snupkg`) for managed consumers.
