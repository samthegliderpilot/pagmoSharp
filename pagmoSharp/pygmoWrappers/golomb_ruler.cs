...
public partial class golomb_ruler : global::System.IDisposable {
  ...
  public ThreadSafety get_thread_safety() {
    ThreadSafety ret = (ThreadSafety)pagmoPINVOKE.golomb_ruler_get_thread_safety(swigCPtr);
    if (pagmoPINVOKE.SWIGPendingException.Pending) throw pagmoPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public problem to_problem() {
    problem ret = new problem(pagmoPINVOKE.golomb_ruler_to_problem(swigCPtr), true);
    if (pagmoPINVOKE.SWIGPendingException.Pending) throw pagmoPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
