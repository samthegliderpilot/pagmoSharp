...
{
    [TestFixture]
    public class Testcec2006 : TestProblemBase
    {
        ...
        public override void TestOptimizing()
        {
            ...
            using (var pop = new population(problemBase2, 1024))
            {
                ...
                Assert.AreEqual(0.991d, champX[0], 1e-1, "1.0 for first x value");
                ...
                Assert.AreEqual(-13.958335227318944, champF[0], 1.0, "optimal function value");
