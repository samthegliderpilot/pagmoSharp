...
- Generation timestamp (UTC): 2026-04-15 03:53:05Z
...
- `string METHOD_GRID { get }`
  - Summary: Gets or sets `METHOD_GRID`.
- `string METHOD_LOW_DISCREPANCY { get }`
  - Summary: Gets or sets `METHOD_LOW_DISCREPANCY`.
- `string METHOD_RANDOM { get }`
  - Summary: Gets or sets `METHOD_RANDOM`.
...
- Kind: class
- Summary: Represents `pagmo.ProblemManualFunctions` in the managed pagmo API surface.
- Upstream reference: https://esa.github.io/pagmo2/docs/cpp/cpp_docs.html
...
- `IReadOnlyList<GacoLogLine> GetTypedLogLines()`
  - Summary: Invokes `GetTypedLogLines`.
- `population evolve(population arg0)`
  - Summary: Invokes `evolve`.
- `string get_extra_info()`
  - Summary: Invokes `get_extra_info`.
...
- `SparsityIndex[] GetGradientSparsityEntries()`
  - Summary: Invokes `GetGradientSparsityEntries`.
...
- `void Finalize()`
  - Summary: Invokes `Finalize`.
- `SparsityIndex[][] GetHessiansSparsityEntries()`
  - Summary: Invokes `GetHessiansSparsityEntries`.
- `DoubleVector fitness(DoubleVector arg0)`
  - Summary: Invokes `fitness`.
- `PairOfDoubleVectors get_bounds()`
  - Summary: Invokes `get_bounds`.
...
- `SparsityPattern GradientSparsity()`
  - Summary: Invokes `GradientSparsity`.
...
- Kind: class
- Summary: Represents r_policy. Uses pagmo-native semantics. See docs/api-reference.md for upstream links.
- Upstream reference: https://esa.github.io/pagmo2/docs/cpp/r__policy.html

### Constructors

- `r_policy()`
  - Summary: Initializes a `r_policy` instance.
...
- Kind: class
- Summary: Represents `pagmo.r_policyBase` in the managed pagmo API surface.
- Upstream reference: https://esa.github.io/pagmo2/docs/cpp/cpp_docs.html

### Constructors

- `r_policyBase()`
  - Summary: Initializes a `r_policyBase` instance.
...
- Kind: class
- Summary: Represents `pagmo.r_policyBase+SwigDelegater_policyBase_0` in the managed pagmo API surface.
- Upstream reference: https://esa.github.io/pagmo2/docs/cpp/cpp_docs.html

### Constructors

- `SwigDelegater_policyBase_0(object object, IntPtr method)`
  - Summary: Initializes a `SwigDelegater_policyBase_0` instance.
...
- Kind: class
- Summary: Represents `pagmo.r_policyBase+SwigDelegater_policyBase_1` in the managed pagmo API surface.
- Upstream reference: https://esa.github.io/pagmo2/docs/cpp/cpp_docs.html

### Constructors

- `SwigDelegater_policyBase_1(object object, IntPtr method)`
  - Summary: Initializes a `SwigDelegater_policyBase_1` instance.
...
- Kind: class
- Summary: Represents `pagmo.r_policyBase+SwigDelegater_policyBase_2` in the managed pagmo API surface.
- Upstream reference: https://esa.github.io/pagmo2/docs/cpp/cpp_docs.html

### Constructors

- `SwigDelegater_policyBase_2(object object, IntPtr method)`
  - Summary: Initializes a `SwigDelegater_policyBase_2` instance.
...
- Kind: class
- Summary: Represents `pagmo.r_policyBase+SwigDelegater_policyBase_3` in the managed pagmo API surface.
- Upstream reference: https://esa.github.io/pagmo2/docs/cpp/cpp_docs.html

### Constructors

- `SwigDelegater_policyBase_3(object object, IntPtr method)`
  - Summary: Initializes a `SwigDelegater_policyBase_3` instance.
...
- Kind: class
- Summary: Represents `pagmo.r_policyPagmoWrapper` in the managed pagmo API surface.
- Upstream reference: https://esa.github.io/pagmo2/docs/cpp/cpp_docs.html

### Constructors

- `r_policyPagmoWrapper()`
  - Summary: Initializes a `r_policyPagmoWrapper` instance.
...
- Kind: class
- Summary: Represents s_policy. Uses pagmo-native semantics. See docs/api-reference.md for upstream links.
- Upstream reference: https://esa.github.io/pagmo2/docs/cpp/s__policy.html

### Constructors

- `s_policy()`
  - Summary: Initializes a `s_policy` instance.
...
- Kind: class
- Summary: Represents `pagmo.s_policyBase` in the managed pagmo API surface.
- Upstream reference: https://esa.github.io/pagmo2/docs/cpp/cpp_docs.html

### Constructors

- `s_policyBase()`
  - Summary: Initializes a `s_policyBase` instance.
...
- Kind: class
- Summary: Represents `pagmo.s_policyBase+SwigDelegates_policyBase_0` in the managed pagmo API surface.
- Upstream reference: https://esa.github.io/pagmo2/docs/cpp/cpp_docs.html

### Constructors

- `SwigDelegates_policyBase_0(object object, IntPtr method)`
  - Summary: Initializes a `SwigDelegates_policyBase_0` instance.
...
- Kind: class
- Summary: Represents `pagmo.s_policyBase+SwigDelegates_policyBase_1` in the managed pagmo API surface.
- Upstream reference: https://esa.github.io/pagmo2/docs/cpp/cpp_docs.html

### Constructors

- `SwigDelegates_policyBase_1(object object, IntPtr method)`
  - Summary: Initializes a `SwigDelegates_policyBase_1` instance.
...
- Kind: class
- Summary: Represents `pagmo.s_policyBase+SwigDelegates_policyBase_2` in the managed pagmo API surface.
- Upstream reference: https://esa.github.io/pagmo2/docs/cpp/cpp_docs.html

### Constructors

- `SwigDelegates_policyBase_2(object object, IntPtr method)`
  - Summary: Initializes a `SwigDelegates_policyBase_2` instance.
...
- Kind: class
- Summary: Represents `pagmo.s_policyBase+SwigDelegates_policyBase_3` in the managed pagmo API surface.
- Upstream reference: https://esa.github.io/pagmo2/docs/cpp/cpp_docs.html

### Constructors

- `SwigDelegates_policyBase_3(object object, IntPtr method)`
  - Summary: Initializes a `SwigDelegates_policyBase_3` instance.
...
- Kind: class
- Summary: Represents `pagmo.s_policyPagmoWrapper` in the managed pagmo API surface.
- Upstream reference: https://esa.github.io/pagmo2/docs/cpp/cpp_docs.html

### Constructors

- `s_policyPagmoWrapper()`
  - Summary: Initializes a `s_policyPagmoWrapper` instance.
