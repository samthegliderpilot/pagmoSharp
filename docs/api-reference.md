...
- Kind: class
- Summary: Represents `pagmo.VectorOfVectorIndexes` in the managed pagmo API surface.
- Upstream reference: https://esa.github.io/pagmo2/docs/cpp/cpp_docs.html

### Constructors

- `VectorOfVectorIndexes()`
  - Summary: Initializes a `VectorOfVectorIndexes` instance.
...
- Kind: class
- Summary: Represents `pagmo.VectorOfVectorIndexes+VectorOfVectorIndexesEnumerator` in the managed pagmo API surface.
- Upstream reference: https://esa.github.io/pagmo2/docs/cpp/cpp_docs.html

### Constructors

- `VectorOfVectorIndexesEnumerator(VectorOfVectorIndexes collection)`
  - Summary: Initializes a `VectorOfVectorIndexesEnumerator` instance.
