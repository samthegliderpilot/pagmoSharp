...
public partial class inventory : global::System.IDisposable {
  ...
  public ThreadSafety get_thread_safety() {
    ThreadSafety ret = (ThreadSafety)pagmoPINVOKE.inventory_get_thread_safety(swigCPtr);
    if (pagmoPINVOKE.SWIGPendingException.Pending) throw pagmoPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public problem to_problem() {
    problem ret = new problem(pagmoPINVOKE.inventory_to_problem(swigCPtr), true);
    if (pagmoPINVOKE.SWIGPendingException.Pending) throw pagmoPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
